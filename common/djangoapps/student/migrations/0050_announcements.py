...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Announcements'
        db.create_table('student_announcements', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('announcement', self.gf('django.db.models.fields.CharField')(default='lorem ipsum', max_length=1000)),
            ('announcement_id', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('student', ['Announcements'])
    ...
    def backwards(self, orm):
        # Deleting model 'Announcements'
        db.delete_table('student_announcements')
    ...
    models = {
        ...
        'student.announcements': {
            ...
            'announcement': ('django.db.models.fields.CharField', [], {'default': "'lorem ipsum'", 'max_length': '1000'}),
            'announcement_id': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
