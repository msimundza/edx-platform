(function() {
  ...
  subject_formatter = function(row, cell, value, columnDef, dataContext) {
    ...
    return edx.HtmlUtils.joinHtml(edx.HtmlUtils.HTML('<p><a href="#email_message_'), value['id'], edx.HtmlUtils.HTML('" id="email_message_'), value['id'], edx.HtmlUtils.HTML('_trig">'), subject_text, edx.HtmlUtils.HTML('</a></p>'));
  };
